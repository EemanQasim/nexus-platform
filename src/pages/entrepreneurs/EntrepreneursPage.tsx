...
export const EntrepreneursPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-dark-900">Find Startups</h1>
        <p className="text-dark-600">Discover promising startups looking for investment</p>
      </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-6">
              <div>
                <h3 className="text-sm font-medium text-dark-900 mb-2">Industry</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-dark-900 mb-2">Funding Range</h3>
                <div className="space-y-2">
