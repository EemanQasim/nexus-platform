...
export const HelpPage: React.FC = () => {
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-dark-900">Help & Support</h1>
        <p className="text-dark-600">Find answers to common questions or get in touch with our support team</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardBody className="text-center p-6">
            ...
            <h2 className="text-lg font-medium text-dark-900">Documentation</h2>
        ...
        <Card>
          <CardBody className="text-center p-6">
            ...
            <h2 className="text-lg font-medium text-dark-900">Live Chat</h2>
            <p className="text-sm text-dark-600 mt-2">
        ...
        <Card>
          <CardBody className="text-center p-6">
            ...
            <h2 className="text-lg font-medium text-dark-900">Contact Us</h2>
            <p className="text-sm text-dark-600 mt-2">
      ...
      <Card>
        <CardHeader>
          <h2 className="text-lg font-medium text-dark-900">Frequently Asked Questions</h2>
        </CardHeader>
        <CardBody>
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-dark-200 last:border-0 pb-6 last:pb-0">
                <h3 className="text-base font-medium text-dark-900 mb-2">
                  {faq.question}
                </h3>
      ...
      <Card>
        <CardHeader>
          <h2 className="text-lg font-medium text-dark-900">Still need help?</h2>
        </CardHeader>
        <CardBody>
