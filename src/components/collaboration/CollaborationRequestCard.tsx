      ...
      <CardBody className="flex flex-col">
        <div className="flex justify-between items-start">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-md font-semibold text-dark-900">{investor.name}</h3>
        ...
        <div className="mt-4">
          <p className="text-sm text-dark-600">{request.message}</p>
        </div>
      </CardBody>
      
      <CardFooter className="border-t border-dark-100 bg-dark-50">
