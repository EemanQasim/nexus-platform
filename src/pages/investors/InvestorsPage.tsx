...
export const InvestorsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-dark-900">Find Investors</h1>
        <p className="text-dark-600">Connect with investors who match your startup's needs</p>
      </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-6">
              <div>
                <h3 className="text-sm font-medium text-dark-900 mb-2">Investment Stage</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-dark-900 mb-2">Investment Interests</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-dark-900 mb-2">Location</h3>
                <div className="space-y-2">
                  <button className="flex items-center w-full text-left px-3 py-2 rounded-md text-sm text-dark-700 hover:bg-dark-50">
