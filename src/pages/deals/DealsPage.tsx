  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-dark-900">Investment Deals</h1>
          <p className="text-dark-600">Track and manage your investment pipeline</p>
        </div>
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-dark-600">Total Investment</p>
                <p className="text-lg font-semibold text-dark-900">$4.3M</p>
              </div>
            </div>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-dark-600">Active Deals</p>
                <p className="text-lg font-semibold text-dark-900">8</p>
              </div>
            </div>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-dark-600">Portfolio Companies</p>
        ...
        <Card>
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-dark-600">Closed This Month</p>
                <p className="text-lg font-semibold text-dark-900">2</p>
              </div>
            </div>
          </CardBody>
        </Card>
      ...
      <Card>
        <CardHeader>
          <h2 className="text-lg font-medium text-dark-900">Active Deals</h2>
        </CardHeader>
        <CardBody>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {deals.map(deal => (
                  <tr key={deal.id} className="hover:bg-dark-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-dark-900">{deal.amount}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-dark-900">{deal.equity}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-dark-900">{deal.stage}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-dark-500">
