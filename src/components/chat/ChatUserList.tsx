...
export const ChatUserList: React.FC<ChatUserListProps> = ({ conversations }) => {
  ...
  return (
    <div className="bg-white border-r border-dark-200 w-full md:w-64 overflow-y-auto">
      <div className="py-4">
        <h2 className="px-4 text-lg font-semibold text-dark-800 mb-4">Messages</h2>
                ...
                <div
                  ...
                  className={`px-4 py-3 flex cursor-pointer transition-colors duration-200 ${
                    isActive
                      ...
                      : 'hover:bg-dark-50 border-l-4 border-transparent'
                  }`}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-baseline">
                      <h3 className="text-sm font-medium text-dark-900 truncate">
                        {otherUser.name}
                      </h3>
